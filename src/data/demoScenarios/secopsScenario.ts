...
export const secopsScenarioData: DemoScenarioData = {
  ...
  auditEvents: [
    {
      id: 'au-secops-001',
      timestamp: '2026-08-08T06:15:00',
      actor: 'Sam Bernard',
      action: 'Consultation des alertes de sécurité',
    ...
    },
    {
      ...
      actor: 'Système',
      action: 'Alerte critique — Échec OAuth Salesforce Staging',
      ipAddress: '10.0.0.1',
      status: 'success',
    },
    {
      ...
      actor: 'Système',
      action: 'Tentative de connexion suspecte (Salesforce Staging)',
    ...
    },
    {
      ...
      actor: 'Lucas Dupont',
      action: 'Ré-authentification clés API',
