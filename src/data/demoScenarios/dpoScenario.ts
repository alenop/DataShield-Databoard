  ...
  auditEvents: [
    {
      ...
      action: 'Consultation politique Rétention Légale 7 ans',
    ...
    },
    {
      ...
      actor: 'Camille Renard',
      action: 'Demande d\'export CSV — échantillon auditeur',
      ipAddress: '172.16.0.8',
      status: 'success',
    },
    {
      ...
      actor: 'Sophie Martin',
      action: 'Accès aux données Contacts (Production)',
    ...
    },
    {
      ...
      actor: 'Lucas Dupont',
      action: 'Export des données Comptes',
    ...
    },
    {
      ...
      actor: 'Camille Renard',
      action: 'Extraction rapport d\'audit — filtre 30 jours',
      ipAddress: '172.16.0.8',
      status: 'success',
    },
    {
      ...
      actor: 'Admin Demo',
      action: 'Modification périmètre source Production',
      ipAddress: '192.168.1.45',
      status: 'success',
    },
    {
      ...
      actor: 'Sam Bernard',
      action: 'Consultation journal d\'audit',
